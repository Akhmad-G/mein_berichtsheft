...
<head>
  ...
  <link rel="icon"
        href="{{ asset('favicon-light.ico') }}"
        media="(prefers-color-scheme: light)"
  >
  <link rel="icon"
        href="{{ asset('favicon-dark.ico') }}"
...
<body class="font-sans bg-paper text-ink antialiased">
  ...
  <header class="max-w-5xl mx-auto px-8 pt-12 pb-20 grid grid-cols-1 md:grid-cols-2 gap-14 items-center">
    <div>
      ...
      <h1 class="font-display text-4xl md:text-[44px] leading-[1.14] max-w-md">
        Der Ausbildungsnachweis, den du nicht am Freitagabend zusammensuchen musst. </h1>
      <p class="mt-5 text-[17px] leading-relaxed text-ink-soft max-w-sm">
        Tagesberichte schreibst du, wann sie passieren — jederzeit bearbeitbar oder löschbar. Dein Wochenbericht
    ...
    <div class="bg-paper-line border border-rule rounded-xl px-6 pt-6 pb-6 max-w-sm md:ml-auto shadow-[0_18px_40px_-20px_rgba(32,38,44,0.25)]">
      ...
      <div class="flex items-center justify-between mt-4 pt-4 border-t border-rule">
        <svg viewBox="0 0 96 34"
             class="w-24 h-[34px] text-ink"
        >
  ...
  {{-- ================= ABLAUF ================= --}}
  <section id="ablauf"
           class="border-t border-rule py-16"
  >
    <div class="max-w-5xl mx-auto px-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-9 mt-11">
        <div>
          ...
          <p class="text-[14px] text-ink-soft leading-relaxed">Ausbildungsberuf, Betrieb, Abteilung und Beginn
            hinterlegst du einmal bei der Registrierung.</p>
        </div>
        <div>
          <div class="font-display text-[15px] text-stamp mb-3">2</div>
          <h3 class="text-[17px] font-medium mb-2">Tagesberichte schreiben</h3>
          <p class="text-[14px] text-ink-soft leading-relaxed">Für jeden Tag deiner Ausbildung — jederzeit bearbeitbar
            oder löschbar, solange die Woche offen ist.</p>
        </div>
        <div>
          <div class="font-display text-[15px] text-stamp mb-3">3</div>
          <h3 class="text-[17px] font-medium mb-2">Wochenbericht erstellen</h3>
          <p class="text-[14px] text-ink-soft leading-relaxed">Wird aus deinen Tagesberichten zusammengestellt —
            automatisch befüllt, aber frei von dir anpassbar.</p>
        </div>
        <div>
          <div class="font-display text-[15px] text-stamp mb-3">4</div>
          <h3 class="text-[17px] font-medium mb-2">Unterschreiben</h3>
          <p class="text-[14px] text-ink-soft leading-relaxed">Du unterschreibst deine Zeile, dein Ausbilder seine.
            Danach ist der Bericht gesperrt.</p>
        </div>
      </div>
    </div>
  </section>
        ...
        <div class="bg-paper-line border-b md:border-b-0 md:border-r border-rule p-9">
          ...
          <ul class="mt-4 space-y-2.5">
            <li class="flex gap-2.5 text-[14.5px] text-ink-soft leading-relaxed">
              <x-icon-check />
              Profil und Ausbildungsdaten selbst anlegen </li>
            <li class="flex gap-2.5 text-[14.5px] text-ink-soft leading-relaxed">
              <x-icon-check />
              Tagesberichte schreiben, bearbeiten, löschen </li>
            <li class="flex gap-2.5 text-[14.5px] text-ink-soft leading-relaxed">
              <x-icon-check />
              Wochenbericht aus den eigenen Einträgen erstellen und anpassen </li>
            <li class="flex gap-2.5 text-[14.5px] text-ink-soft leading-relaxed">
              <x-icon-check />
              Eigene Zeile unterschreiben — nicht die des Ausbilders </li>
          </ul>
        </div>
        <div class="p-9">
          ...
          <ul class="mt-4 space-y-2.5">
            <li class="flex gap-2.5 text-[14.5px] text-ink-soft leading-relaxed">
              <x-icon-check />
              Aktuell vom Betrieb eingerichtet, Azubis fest zugeordnet </li>
            <li class="flex gap-2.5 text-[14.5px] text-ink-soft leading-relaxed">
              <x-icon-check />
              Wochenberichte der zugeordneten Azubis einsehen </li>
            <li class="flex gap-2.5 text-[14.5px] text-ink-soft leading-relaxed">
              <x-icon-check />
              Eigene Zeile unterschreiben, ohne Einträge zu verändern </li>
            <li class="flex gap-2.5 text-[14.5px] text-ink-soft leading-relaxed">
              <x-icon-check />
              Kein Zugriff auf Berichte fremder Azubis </li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="max-w-5xl mx-auto px-8">
      ...
      <div class="border-t border-rule">
        <div class="flex justify-between items-baseline gap-6 py-5 border-b border-rule">
          ...
          <div class="text-[14px] text-ink-soft text-right max-w-sm">Azubi schreibt und bearbeitet, Ausbilder sieht und
            unterschreibt — keiner unterschreibt für den anderen.
          </div>
        </div>
        <div class="flex justify-between items-baseline gap-6 py-5 border-b border-rule">
          <div class="text-[16px] font-medium max-w-xs">Gesperrt nach Unterschrift</div>
          <div class="text-[14px] text-ink-soft text-right max-w-sm">Ein unterschriebener Wochenbericht kann nicht mehr
            bearbeitet oder gelöscht werden.
          </div>
        </div>
        <div class="flex justify-between items-baseline gap-6 py-5 border-b border-rule">
          <div class="text-[16px] font-medium max-w-xs">PDF-Export</div>
          <div class="text-[14px] text-ink-soft text-right max-w-sm">Wochenbericht als PDF, wahlweise mit oder ohne die
            eingeholten Unterschriften.
          </div>
        </div>
        <div class="flex justify-between items-baseline gap-6 py-5 border-b border-rule">
          <div class="text-[16px] font-medium max-w-xs">Eigenes GitLab als Speicher</div>
          <div class="text-[14px] text-ink-soft text-right max-w-sm">Jede Version wird abgelegt und ist
            wiederherstellbar — die Daten bleiben in eurer eigenen Infrastruktur.
          </div>
        </div>
      </div>

      <p class="text-[13px] text-ink-soft mt-6">
        Geplant: Rollenwahl bei der Registrierung, direkte Azubi-Ausbilder-Zuordnung, Kalenderansicht für Wochen und
        Monate, Speicherung zusätzlich als Markdown. </p>
    </div>
  </section>
  ...
  <footer class="max-w-5xl mx-auto px-8 py-8 flex justify-between text-[13px] text-ink-soft">
    <span>{{ config('app.name', 'Mein Tagesbericht') }}</span> <span>Für Ausbildungsbetriebe in Deutschland</span>
  </footer>
