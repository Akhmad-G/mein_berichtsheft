...
<a href="{{ url('/') }}" class="flex items-center gap-2.5 no-underline text-ink">
    <svg viewBox="0 0 120 120" style="width: {{ $size }}px; height: {{ $size }}px" xmlns="http://www.w3.org/2000/svg">
    ...
    <span class="font-display font-medium" style="font-size: {{ $text }}px">Mein Tagesbericht</span>
</a>
