@php
    ...
    $weekValue = old('week', isset($report['week_start'])
        ? \Carbon\Carbon::parse($report['week_start'])->format('o-\WW')
        : now()->format('o-\WW'));
...
<div class="py-8 max-w-4xl mx-auto">
  ...
  <form method="POST" action="{{ $action }}" id="wochenbericht-form">
    @csrf
    ...
    <input type="hidden" name="week" id="week-hidden" value="{{ $weekValue }}">
